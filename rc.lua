...
--Delightful
local delightful = require("delightful")
...
tyrannical.tags = {
    {
        ...
        class       = { --Accept the following classes, refuse everything else (because of "exclusive=true")
            "xterm" , "urxvt" , "aterm","URxvt","XTerm","konsole","terminator","gnome-terminal", "guake"
        }
    } ,
    {
        name = "Develop",
        ...
        class ={ 
            "Kate", "KDevelop", "Codeblocks", "Code::Blocks" , "DDD", "kate4", "sublime_text"}
    } , 
    {
        name        = "Internet",
        init        = true,
    ...
    
    {
        ...
        class       = {
            ...
            "Xpdf"          , "libreoffice-writer", "libreoffice-calc",                                    }
    } ,
    {
        name        = "Comms",
        init        = false, -- This tag wont be created at startup, but will be when one of the
